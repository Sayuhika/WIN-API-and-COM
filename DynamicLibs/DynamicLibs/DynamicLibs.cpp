...
// DynamicLibs.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDynamicLibsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CDynamicLibsApp

CDynamicLibsApp::CDynamicLibsApp()
{
...
// Единственный объект CDynamicLibsApp

CDynamicLibsApp theApp;


// Инициализация CDynamicLibsApp

BOOL CDynamicLibsApp::InitInstance()
{
