...
// ThreadControlMFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CThreadControlMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CThreadControlMFCApp

CThreadControlMFCApp::CThreadControlMFCApp()
{
...
// Единственный объект CThreadControlMFCApp

CThreadControlMFCApp theApp;


// Инициализация CThreadControlMFCApp

BOOL CThreadControlMFCApp::InitInstance()
{
