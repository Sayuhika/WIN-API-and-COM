...
// SynchronizationOfThreadsMFCv2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSynchronizationOfThreadsMFCv2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSynchronizationOfThreadsMFCv2App

CSynchronizationOfThreadsMFCv2App::CSynchronizationOfThreadsMFCv2App()
{
...
// Единственный объект CSynchronizationOfThreadsMFCv2App

CSynchronizationOfThreadsMFCv2App theApp;


// Инициализация CSynchronizationOfThreadsMFCv2App

BOOL CSynchronizationOfThreadsMFCv2App::InitInstance()
{
	...
	CSynchronizationOfThreadsMFCv2Dlg dlg;
	m_pMainWnd = &dlg;
