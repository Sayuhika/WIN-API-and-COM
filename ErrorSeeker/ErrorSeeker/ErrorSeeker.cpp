...
// ErrorSeeker.cpp: определяет поведение классов для приложения.
//

#include "pch.h"
#include "framework.h"
#include "ErrorSeeker.h"
...
BEGIN_MESSAGE_MAP(CErrorSeekerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CErrorSeekerApp

CErrorSeekerApp::CErrorSeekerApp()
{
...
// Единственный объект CErrorSeekerApp

CErrorSeekerApp theApp;


// Инициализация CErrorSeekerApp

BOOL CErrorSeekerApp::InitInstance()
{
