...
// Codeerror.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCodeerrorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CCodeerrorApp

CCodeerrorApp::CCodeerrorApp()
{
...
// Единственный объект CCodeerrorApp

CCodeerrorApp theApp;


// инициализация CCodeerrorApp

BOOL CCodeerrorApp::InitInstance()
{
